...
export const defaultToolCategories: ImportedToolCategory[] = [
  ...
  },
  {
    ...
    tools: [
      ...
      { name: "Move X", icon: <Move />, action: "move-x", type: "transform" },
      { name: "Move Y", icon: <Move />, action: "move-y", type: "transform" },
      { name: "Move Z", icon: <Move />, action: "move-z", type: "transform" },
      { name: "Rotate", icon: <RotateCw />, action: "rotate", type: "transform" },
      { name: "Rotate X", icon: <RotateCw />, action: "rotate-x", type: "transform" },
      { name: "Rotate Y", icon: <RotateCw />, action: "rotate-y", type: "transform" },
      { name: "Rotate Z", icon: <RotateCw />, action: "rotate-z", type: "transform" },
      { name: "Scale", icon: <Maximize />, action: "scale", type: "transform" },
      { name: "Scale Uniform", icon: <Maximize />, action: "scale-uniform", type: "transform" },
      { name: "Scale X", icon: <Maximize />, action: "scale-x", type: "transform" },
      { name: "Scale Y", icon: <Maximize />, action: "scale-y", type: "transform" },
      { name: "Scale Z", icon: <Maximize />, action: "scale-z", type: "transform" },
    ],
  },
  {
    name: "Measure",
