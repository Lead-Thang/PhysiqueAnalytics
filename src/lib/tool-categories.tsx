...
export const defaultToolCategories: ToolCategory[] = [
  {
    ...
    tools: [
      ...
      { name: "Cylinder", icon: <Cylinder />, action: "add-cylinder", type: "shape" },
      ...
      { name: "Wedge", icon: <CornerDownRight />, action: "add-wedge", type: "shape" },
    ],
  },
  {
    name: "Operations",
  ...
  },
  {
    ...
    tools: [
      ...
      { name: "Move 3D", icon: <Move3D />, action: "move-3d", type: "transform" },
      { name: "Rotate", icon: <RotateCw />, action: "rotate", type: "transform" },
  ...
  },
  {
    ...
    expanded: false,
    tools: [
      { name: "Distance", icon: <BoxSelect />, action: "measure-distance", type: "measure" },
      { name: "Volume", icon: <Play />, action: "measure-volume", type: "measure" },
      { name: "Area", icon: <Layers />, action: "measure-area", type: "measure" },
    ],
  },
  {
    name: "View",
    ...
    expanded: false,
    tools: [
      { name: "Wireframe", icon: <Hexagon />, action: "view-wireframe", type: "view" },
      { name: "Shaded", icon: <Palette />, action: "view-shaded", type: "view" },
      { name: "Animation", icon: <Play />, action: "animate-scene", type: "view" },
    ],
  },
  {
    name: "Edit",
    ...
    expanded: false,
    tools: [
      { name: "Delete", icon: <Trash2 />, action: "delete-selected", type: "operation" },
  ...
  },
  {
    ...
    tools: [
      ...
      { name: "Clear Seam", icon: <Hexagon />, action: "clear-seam", type: "operation" },
      { name: "Mark Sharp", icon: <Triangle />, action: "mark-sharp", type: "operation" },
      { name: "Clear Sharp", icon: <Triangle />, action: "clear-sharp", type: "operation" },
      { name: "Set Sharpness by Angle", icon: <Ruler />, action: "set-sharpness-by-angle", type: "operation" },
      { name: "Un-Subdivide", icon: <Minus />, action: "un-subdivide", type: "operation" },
